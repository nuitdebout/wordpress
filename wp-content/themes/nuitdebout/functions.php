...
function twentysixteen_scripts() {
	...
	// nuitdebout
	wp_enqueue_style( 'materialize',get_template_directory_uri() . '/css/materialize.min.css', array(  ), '20160414' );
	wp_enqueue_style( 'nuitdebout-style', get_stylesheet_uri() );
	...
	wp_enqueue_script( 'materialize', get_template_directory_uri() . '/js/materialize.min.js', array(), '20160412', true );
	wp_enqueue_script( 'underscore', get_template_directory_uri() . '/js/underscore-min.js', array(), '20160412', true );
	wp_enqueue_script( 'succinct', get_template_directory_uri() . '/js/jQuery.succinct.min.js', array('jquery'), '20160412', true );
